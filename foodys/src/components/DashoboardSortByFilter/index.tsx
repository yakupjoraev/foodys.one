...
export type DashboardSortByFilterProps = PropsWithChildren<{
  label: string;
}>;

export function DashboardSortByFilter(props: DashboardSortByFilterProps) {
  ...
  return (
    <div
      className={classNames(
        "dashboard__filter dashboard__filter--sort",
        active && "active"
      )}

...
function restaurantLike() {
  const restaurantLikeBtn = document.querySelector('[data-restaurant-like]');

  restaurantLikeBtn.addEventListener('click', ()=> {
    restaurantLikeBtn.classList.toggle('liked');
  })
}
restaurantLike();
